Gem::Specification.new do |spec|
  ...
  spec.files             = Dir.glob('ext/**/*') + %w(lib/libarchive.rb lib/libarchive_ruby.rb README.txt ext/libarchive.c COPYING.libarchive LICENSE.libbzip2)
  ...
  spec.extra_rdoc_files  = %w(README.txt ext/libarchive.c COPYING.libarchive LICENSE.libbzip2)
